  ...
  return (
    <section className="relative w-full bg-background py-24 md:py-32">
      ...
      <div className="container-custom">
        ...
        <div id="contact" className="flex flex-col lg:flex-row gap-20 lg:gap-32 justify-between scroll-mt-32">
          <div className="lg:max-w-2xl">
            <span className="text-[10px] font-bold tracking-[0.5em] text-white/20 uppercase mb-8 block">
              Let's Talk
            </span>
            <h2 className="text-5xl sm:text-6xl md:text-7xl font-black text-white tracking-tighter leading-[0.85] mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 mt-24">
              <div>
                ...
                <a href="mailto:harrisraj10d@gmail.com" className="text-xl md:text-2xl font-light text-white hover:text-white/60 transition-colors border-b border-white/10 pb-1">
          ...
          <div className="w-full lg:max-w-sm flex flex-col justify-end">
            <div className="p-10 md:p-12 rounded-[40px] bg-white/[0.02] border border-white/5 backdrop-blur-xl group hover:border-white/10 transition-all">
               <Mail className="text-white/20 mb-10 group-hover:text-white transition-colors animate-pulse" size={40} />
               ...
               <button 
                  ...
                  className="w-full py-5 bg-white text-black rounded-full font-bold uppercase tracking-[0.2em] text-[10px] hover:bg-white/90 transition-all active:scale-95"
               >
                 Send Quick Message
               </button>
            </div>
